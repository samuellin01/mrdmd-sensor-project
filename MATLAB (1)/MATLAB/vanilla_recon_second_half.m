%% Script to reconstruct PM2.5 data using POD/QR for 2005-16

clear; close all; clc;
datpath = '../DATA/';
figpath = '../FIGURES/250sensors_qr_pt2';
...
Itest = [1752 2575 3366 3820]; % 07/1/10, 10/1/12, 12/1/14, 03/1/16
indt = 1; % Index of Itest to run reconstruction
