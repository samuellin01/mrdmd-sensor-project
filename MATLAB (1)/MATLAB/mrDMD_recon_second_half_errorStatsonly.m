%% Script to reconstruct snapshots of PM2.5 data (2005-16) using mrDMD algorithm
...
dat = datX(:,:,setdiff((2082:6180),[3291,5689,5690]));
dat2 = datX(:,:,setdiff((1:4097),[3291]));
...
% mrDMD, 4096-day period ending in 2016
...
%mkelp
time = setdiff((1:4097),[3291]); %mkelp
...
%% display reconstructions of PM25 data from multiscale sensors
