...
clear; close all; clc
datpath = '../DATA/';
%figpath = '../FIGURES/250sensors_AE_FE_Errors2007WINTER';
figpath = '../FIGURES/FIRES_RECONS/mrDMD/2007/mrDMDsensors_2007SUMMER_';
...
%indt = linspace(2739,2739+62,63) %July-August 2002 fire
%indt = linspace(720,720+45,46) %January 2002 winter
%indt = linspace(2557,2557+45,46) %January-Feb 2007 winter
