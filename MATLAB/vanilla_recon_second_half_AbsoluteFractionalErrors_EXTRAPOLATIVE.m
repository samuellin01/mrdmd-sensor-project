...
clear; close all; clc;
datpath = '../DATA/';
%figpath = '../FIGURES/QR250sensors_AE_FE_Errors2012WINTER';
figpath = '../FIGURES/FIRES_RECONS/QRsensors_EXTRAPOLATIVE_2002FIRES_';
...
%Itest = linspace(2483,2483+122,123) %July-Oct 2012 fire
%Itest = linspace(3092,3092+50,51) %Jan 2012 winter
%Itest = linspace(2301-40,2301+40,81) %Jan 2012 winter
